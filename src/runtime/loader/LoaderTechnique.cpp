...
#include "technique/LightPhotonMappingTechnique.h"
...
static std::shared_ptr<Technique> lpm_loader(const std::shared_ptr<Parser::Object>& obj)
{
    return std::make_shared<LightPhotonMappingTechnique>(*obj);
}
